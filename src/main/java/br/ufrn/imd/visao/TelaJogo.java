...
public class TelaJogo extends JFrame implements ActionListener {
	...
	private void atualizarTabuleiro() {
		...
		if(jogo.getEstado() == EstadoDeJogo.GAMEOVER) {
			...
			String vencedor = "VitÛria das peÁas ";
			
			if(jogo.getTabuleiro().isVezDasBrancas()) {
				System.out.println("VitÛria das peÁas pretas");
				vencedor = vencedor + "pretas.";
			} else {
				System.out.println("VitÛria das peÁas brancas");
			...
			JButton denovo = new JButton("RecomeÁar?");
